...
const CustomerList = ({setMessage, setShowMessage, setIsPositive}) => {
    ...
    //Delete -toimintoon liittyvä funktio, tekee poiston
            ...
            CustomerService.remove(id)
                .then(response => {
                    ...
                    if (response.status === 200) {
                        ...
                        window.scrollBy(0, -10000)//Scrollaa ylöspäin
    ...
    return (
        <>
            ...
            {lisäysTila && <CustomerAdd setLisäystila={setLisäystila} setNäytetäänkö={setNäytetäänkö} customers={customers} 
            setCustomers={setCustomers} setMessage={setMessage} setShowMessage={setShowMessage} setIsPositive={setIsPositive} />}
        </>
    )
}
